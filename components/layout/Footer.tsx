      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm">
              ...
              Juntos construímos uma sociedade mais justa, levando 
                ...
                <ul className="space-y-2">
                  {section.items.map((item) => (
                    <li key={item.label}>
                      ...
                      >
                        {item.label}
                        {item.href.includes('mailto') && <Mail className="w-4 h-4" />}
                      </Link>
                    </li>
                  ))}
                </ul>
        ...
        <div className="border-t mt-12 pt-8 text-center space-y-2">
          <p className="text-sm text-gray-500">
            &copy; 2024 Associação Vinícius Carvalheido. Todos os direitos reservados.
          </p>
